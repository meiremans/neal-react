...
export class HorizontalSplit extends React.Component {
    ...
    static propTypes = {
        ...
        extraRowClass: React.PropTypes.string,
        extraColumnClass: React.PropTypes.string
    };
        ...
        return (
            <Row
                ...
                {this.props.children.map((child, idx) => {
                    return (
                        <Col size={HorizontalSplit.COLUMN_CLASSES[numSections]} className={`neal-horizontal-split-col ${this.props.extraColumnClass}`}
                             key={idx}>
                            {child}
                        </Col>
                    );
